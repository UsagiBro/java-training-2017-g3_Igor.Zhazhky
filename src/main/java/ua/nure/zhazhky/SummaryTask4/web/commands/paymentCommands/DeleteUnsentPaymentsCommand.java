...
public class DeleteUnsentPaymentsCommand extends Command {
    private static final Logger LOG = Logger.getLogger(DeleteUnsentPaymentsCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ApplicationException {
        ...
        FACADE.deletePreparedPayments(user.getLogin());
