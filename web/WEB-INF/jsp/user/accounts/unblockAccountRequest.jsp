...
<html>
<c:set var="title" value="Unblock account request" scope="page"/>
                ...
                <form action="/controller" method="post">
                    ...
                    <div class="row">
                        <div class="oaerror info">
                            Here you can send request for account unblock.
                            <strong>After that your account will be available again.</strong>
                        </div>
                    </div>
                    <br>
                    <div class="row">
