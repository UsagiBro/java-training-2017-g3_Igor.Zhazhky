...
<html>
<c:set var="title" value="BlockAccount" scope="page"/>
                ...
                <form action="/controller" method="post">
                    ...
                    <div class="row">
                        <div class="oaerror danger">
                            Seleck an account to block(after blocking account won't be available).
                            <strong>You have to send request for account unblocking.</strong>
                        </div>
                    </div>
                    <br>
                    <div class="row">
